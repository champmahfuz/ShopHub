...
// //     // Clean the shop name for URL (remove spaces and special chars)
...
// //               {/* Dropdown menu */}
// //               {isProfileOpen && (
// //                 <div className="origin-top-right absolute right-0 mt-32 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
// //                   <div className="py-1">
...
// //             You have registered {userData.shops.length} shops.
// //           </p>
// //         </div>
// //       </main> */}
// //       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
// //         <div className="bg-white rounded-lg shadow p-6">
// //           <h2 className="text-lg font-medium text-gray-900">Your Shops</h2>
...
// //               >
// //                 <h3 className="font-medium text-gray-800">{shop}</h3>
...
//   const handleShopClick = (shopName) => {
//     // Convert shop name to URL-friendly format
...
//               You have {userData?.shops?.length || 0} registered shops.
//             </p>
//           </div>
